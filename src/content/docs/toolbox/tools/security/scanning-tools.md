...
Kubescape (avaliação de postura e configuração de workloads e clusters) ainda não tem uma página de catálogo dedicada como as duas ferramentas acima; até que ganhe uma, veja o resumo na tabela [Diagnóstico, segurança e recuperação](../../overview/#diagnóstico-segurança-e-recuperação) do catálogo geral.
