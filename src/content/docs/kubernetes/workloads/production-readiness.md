...
Este guia transforma os itens de prontidão do [guia de operação contínua](../../guides/operations-overview.md) em decisões, validações e evidências aplicáveis a Deployments, StatefulSets, Jobs e CronJobs. Consulte também os [conceitos fundamentais do Kubernetes](../../concepts/kubernetes.md) antes de adaptar os exemplos.
...
- [Conceitos fundamentais do Kubernetes](../../concepts/kubernetes.md)
- [Ciclo de vida de imagens](../../guides/deployment/image-lifecycle.md)
