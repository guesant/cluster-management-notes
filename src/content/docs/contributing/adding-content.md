...
erro nenhum: o componente apenas some silenciosamente (ver
[Decisões do projeto](../../project/decisions/)), então na dúvida use `.mdx`.

## 4. Escreva seguindo o estilo do site

Ver [Estilo de escrita](../documentation-style/), que cobre tom, formatação e convenção de componentes.
...
Ver [Testar conteúdo antes de publicar](../testing-content/), que cobre build, lint, confirmação
visual de componentes interativos e teste dos comandos em si.
...
checklist que referencia esta operação etc.). Isso é um dos critérios de
