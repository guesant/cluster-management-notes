...
A escolha de topologia define quantos servidores (control plane), agentes (workers) e quorum você terá. Não existe uma única resposta "correta" — cada topologia torna-se ideal em um contexto específico.
...
| **HA do control plane** | ❌ Não — perda do servidor = perda total |
