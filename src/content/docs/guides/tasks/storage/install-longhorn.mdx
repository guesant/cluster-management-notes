...
import installLonghornPortForwardLocalScript from '../../../../../scripts/install-longhorn-port-forward-local.sh?raw';
import installLonghornPortForwardManagerScript from '../../../../../scripts/install-longhorn-port-forward-manager.sh?raw';
...
<ScriptHelper
  runWhere="estação administrativa com `KUBECONFIG` e acesso à API"
  script={installLonghornPortForwardLocalScript}
  fields={[{ var: 'LOCAL_PORT', label: 'Porta local para a interface do Longhorn', defaultValue: '8080' }]}
/>
...
<ScriptHelper
  runWhere="nó manager com `KUBECONFIG` e acesso à API"
  script={installLonghornPortForwardManagerScript}
  fields={[{ var: 'MANAGER_PORT', label: 'Porta no manager para a interface do Longhorn', defaultValue: '8080' }]}
/>
