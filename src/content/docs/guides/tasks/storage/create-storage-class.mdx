...
import createStorageClassScript from '../../../../../scripts/create-storage-class.sh?raw';
...
<ScriptHelper
  ...
  script={createStorageClassScript}
  fields={[
    { var: 'STORAGE_CLASS_NAME', label: 'Nome da nova StorageClass' },
    { var: 'REPLICA_COUNT', label: 'Número de réplicas' },
  ]}
/>
