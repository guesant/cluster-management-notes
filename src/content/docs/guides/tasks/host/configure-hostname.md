...
- [`hostnamectl(1)` — systemd](https://www.freedesktop.org/software/systemd/man/latest/hostnamectl.html): referência oficial dos subcomandos e do escopo de cada tipo de hostname.
