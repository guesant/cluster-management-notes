...
import k3sManagerFirewallScript from '../../../../../scripts/k3s-manager-firewall-rules.sh?raw';
...
<ScriptHelper
  runUser="root"
  runWhere="todos os nós manager"
  script={k3sManagerFirewallScript}
  fields={[{ var: 'K3S_NODE_CIDR', label: 'CIDR da rede privada dos nós' }]}
/>
