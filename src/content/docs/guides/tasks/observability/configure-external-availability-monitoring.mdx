...
import externalAvailabilityMonitoringScript from '../../../../../scripts/configure-external-availability-monitoring.sh?raw';
...
<ScriptHelper
  runWhere="qualquer máquina fora do cluster, com saída de rede para o serviço publicado"
  script={externalAvailabilityMonitoringScript}
  fields={[{ var: 'EXTERNAL_CHECK_URL', label: 'URL pública a verificar' }]}
/>
