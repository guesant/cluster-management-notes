...
- [Observability — Kubernetes](https://kubernetes.io/docs/concepts/cluster-administration/observability/): visão geral oficial dos sinais e sua limitação quando o próprio cluster falha.
