---
title: firewalld
description: Modelo de zonas do firewalld — associação por interface/origem, serviços, portas, runtime vs. permanent e sua relação com nftables e containers.
sidebar:
  order: 4
---
...
Dentro de uma zona, regras podem ser expressas como **serviços** (nomes predefinidos, como `ssh` ou `https`, que já sabem quais portas abrir), **portas** individuais, ou **rich rules** — sintaxe mais expressiva para condições que combinam origem, porta, protocolo e ação em uma única regra.
