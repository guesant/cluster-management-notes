...
O reverse proxy precisa de algum critério para associar uma requisição recebida a um backend específico. Os três critérios mais comuns não são mutuamente exclusivos e frequentemente aparecem combinados na mesma instalação.
