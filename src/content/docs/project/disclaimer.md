...
artificial. Alguns scripts e outros conteúdos deste repositório também podem ter sido criados ou
modificados com auxílio de IA. Valide o código, os comandos, as versões e as decisões de segurança
de acordo com o seu ambiente antes de utilizá-los.
:::
...
necessariamente incorreto: significa que a fonte editorial do projeto usa esses assistentes como
...
- Versões e números específicos citados como referência: consulte sempre a fonte upstream listada
  em [Escopo, convenções e versões](../conventions/) antes de aplicar em produção.
