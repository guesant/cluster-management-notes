...
| Atualizações de segurança do SO | [Atualizações automáticas de segurança](../../../guides/tasks/host/configure-automatic-security-updates/) | Contínua, com revisão de reinícios pendentes conforme o `runbook de manutenção`. |
