# Prontidão de workloads para produção

Este guia transforma os itens de prontidão do [guia de operação contínua](../../guides/operations.md) em decisões, validações e evidências aplicáveis a Deployments, StatefulSets, Jobs e CronJobs. Consulte também os [conceitos fundamentais do Kubernetes](../concepts.md) antes de adaptar os exemplos.
...
Use uma ServiceAccount dedicada por workload ou fronteira de privilégio. Se o Pod não chama a API Kubernetes, desabilite a montagem automática do token. Se chama, conceda apenas os recursos e verbos necessários e valide-os conforme o guia de [identidade e RBAC](../security/identity-and-rbac.md).
...
- [Conceitos fundamentais do Kubernetes](../concepts.md)
- [Ciclo de vida de imagens](../../strategies/deployment/image-lifecycle.md)
- [Identidade e RBAC](../security/identity-and-rbac.md)
- [Isolamento com NetworkPolicy](../networking/network-policies.md)
