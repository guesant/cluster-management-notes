...
Listas como `awesome-*`, métricas de popularidade e catálogos de produtos ajudam a encontrar opções, mas não comprovam segurança, manutenção, compatibilidade ou adequação. Para escolhê-las, siga os critérios do [índice de ferramentas e catálogos](tools-and-resources.md) e retorne à fonte oficial de cada projeto.
