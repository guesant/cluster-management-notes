# Ciclo de vida de imagens de containers

Este guia transforma os itens de imagens do [guia de operação contínua](../../guides/operations.md) em um fluxo prático de avaliação, atualização, implantação e rollback. Antes de aplicá-lo a produção, confirme também os requisitos de [prontidão dos workloads](../../k8s/workloads/production-readiness.md) e as [convenções deste repositório](../../reference/conventions.md).
...
8. aprove e integre o PR; então permita que o [Argo CD](argo-cd.md) reconcilie a mudança conforme o [bootstrap GitOps](gitops-bootstrap.md);
